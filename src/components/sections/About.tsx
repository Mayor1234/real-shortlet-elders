              ...
              <div className="flex flex-col w-full ">
                ...
                <div className="mb-8 text-gray-800 leading-loose">
                  <p className="">
                    ...
                    trusted agents and hosts — we offer a unique,
                    ...
                    <ul className="list-disc ml-8">
                      <li>
                        ...
                        networks to maximize rental potential.
                      </li>
                      <li>
                        Conduct Secure Transactions: The platform facilitates
                        safe, seamless transactions for both property owners and
                        short-term renters.
                      </li>
                    </ul>
                    <br />
