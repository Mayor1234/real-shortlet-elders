...
const HeroBanner = () => {
  ...
  return (
    <div className="relative inset-0 z-10 bg-[url('/hero_banner.jpeg')] h-[calc(90vh-60px)] w-screen lg:h-[90vh] bg-no-repeat bg-cover bg-right bg-blend-overlay bg-neutral-700 px-0">
      <Header />
      <div className="container w-full mx-auto">
        <div className="absolute -z-10 px-5 font-normal flex  justify-center gap-5 lg:gap-8 flex-col h-full items-start lg:px-0">
