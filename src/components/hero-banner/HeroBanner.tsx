        ...
        <div className="container w-full mx-auto">
          <div className="absolute -z-10  px-5 font-normal flex justify-center gap-8 flex-col h-full items-start lg:px-0">
            <AnimatedSection direction={{ initial_x: 0, initial_y: 50 }}>
              <h2 className="max-w-md text-3xl text-center uppercase tracking-wide leading-[50px] lg:leading-[70px] text-[#f2f2f2] lg:max-w-[750px] lg:text-5xl lg:text-start pb-10">
            ...
            <button className="overflow-hidden px-6 py-3 font-semibold text-darkLight bg-pry rounded-md self-center lg:self-start">
              Talk to our team
            </button>
          </div>
        </div>
